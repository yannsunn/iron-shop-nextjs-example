        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold">Vintage Iron Works Example</h3>
                <p className="text-slate-400 text-sm">ヴィンテージアイアン製品（サンプル）</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-slate-300">
                  ...
                  <p>東京都千代田区千代田1-1-1</p>
                  <p>エグザンプルビル3F</p>
                  <p className="text-red-400 text-xs mt-1">※サンプル住所</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-300">03-1234-5678 <span className="text-red-400 text-xs">(サンプル)</span></span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-slate-300">info@example-ironshop.com <span className="text-red-400 text-xs">(サンプル)</span></span>
              </div>
            </div>
          </div>
