...
const Hero = () => {
  ...
  return (
    <NeuroOptimizer section="hero" priority="high" className="relative h-screen flex flex-col justify-center text-white overflow-hidden pt-20">
      <section 
        ref={sectionRef}
        id="home" 
      ...
      <div className="relative z-20 text-center max-w-6xl px-6 mx-auto">
        <div className={cn(
